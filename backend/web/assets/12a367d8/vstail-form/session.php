					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Session Name </label>

										<div class="col-sm-9">
											<input type="text" id="session_name" name="session_name" placeholder="Username" class="col-xs-10 col-sm-5" />
										</div>
									</div>
										 	...
										 	<div class="col-xs-1 col-sm-5">
														...
														<div class="space-4"></div>
																<div class="row">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Session List </label>
										<div class="col-xs-10 col-sm-5"></div>
										<span class="help-inline col-xs-12 col-sm-7">
																<select class="form-control" id="form-field-select-1">
																<option value="">&nbsp;</option>
																<option value="AL">Sessi 1 2013</option>
																<option value="AK">Sessi 2 2013</option>
															</select>
														</div>
                           ...
                           <div class="clearfix form-actions">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Course Name </label>

									<div class="col-sm-9">
											<input type="text" id="course_name" name="course_name" placeholder="Cousename" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Course Code </label>

									<div class="col-sm-9">
											<input type="text" id="course_code" name="course_code" placeholder="Code" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									
                                  		<div class="space-4"></div>
                                  			<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Synopsis </label>

									<div class="col-sm-9">
											<input type="text" id="Sysnopsis" name="Synopsis" placeholder="Sysponsis" class="col-xs-10 col-sm-5" />
										</div>
									</div>
                                  		
											<div class="space-4"></div>
																<div class="row">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Number of Trainers </label>
										<div class="col-xs-5 col-sm-10"></div>
										<span class="help-inline col-xs-12 col-sm-7">
																<select class="form-control" id="form-field-select-1">
																<option value="">&nbsp;</option>
										...
										<div class="space-4"></div>
																<div class="row">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> Session</label>
										<div class="col-xs-5 col-sm-10"></div>
										<span class="help-inline col-xs-12 col-sm-7">
																<select class="form-control" id="form-field-select-1">
																<option value="">&nbsp;</option>
											...
											<hr />
														<div>
															<label for="form-field-select-2">Chooses Session</label>

															<select class="form-control" id="form-field-select-2" Chooses_Session="Choosessession">
																<option value="AL">Object Orinted Programming</option>
																<option value="AK">Software Engineering</option>
																<option value="AZ">Software Quality</option>
																<option value="AR">Logic Digital</option>
															</select>
														</div>
